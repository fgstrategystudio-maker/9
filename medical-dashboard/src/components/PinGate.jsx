...
export default function PinGate({ children }) {
  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center z-50" style={{ background: 'linear-gradient(150deg, #15314A 0%, #0E1626 100%)' }}>
      {/* Logo */}
      <div className="flex flex-col items-center mb-10">
        <div className="w-14 h-14 rounded-2xl flex items-center justify-center shadow-xl mb-3"
          style={{ background: 'linear-gradient(135deg, #4FA6DD 0%, #C8A24A 100%)' }}>
          <Heart size={28} className="text-white" fill="white" />
        </div>
        <div className="text-white font-bold text-2xl" style={{ fontFamily: "'Spectral', Georgia, serif" }}>Vitae</div>
