...
export default function Layout({ children, session, onLogout }) {
  ...
  return (
    <div className="flex min-h-screen bg-vitae-bg">
      <aside className="w-64 flex flex-col fixed top-0 left-0 h-full z-10"
        style={{ background: 'linear-gradient(150deg, #15314A 0%, #0E1626 100%)' }}>
        ...
        <div className="flex items-center gap-3 px-5 py-4">
          ...
          <div>
            <div className="font-bold text-white text-base leading-tight tracking-tight" style={{ fontFamily: "'Spectral', Georgia, serif" }}>Vitae</div>
            <div className="text-slate-400 text-xs">Cartella clinica personale</div>
          </div>
        </div>
